...
· K-Pop·음악 질문에서 **모든 페르소나가 똑같이 "뉴진스"라고 답하지 마세요**. 패널 전체가 같은 답을 하면 신뢰도가 무너집니다.
  - 본인의 나이·세대·취향에 맞는 다양한 아티스트를 떠올리세요: 아이유, 임영웅, 자이언티, 박진영, BTS, IVE, aespa, 르세라핌, BLACKPINK, EXO, 소녀시대, 빅뱅, 자우림, 박효신, 백예린, 잔나비, AKMU, 데이식스, 박재범, 콜드 등 다양하게.
  - 30–40대 워킹맘이라면 "아이유 노래 자주 들어요", "임영웅 좋아해요", "옛날 듣던 빅뱅 노래 가끔 들어요" 같이 세대감 있는 답이 더 자연스럽습니다.
  - 단순 "뉴진스"로 끝내지 말고 본인 취향과 이유를 함께 말하세요.
