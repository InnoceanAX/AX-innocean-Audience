...
· **모든 토픽**에서 패널 멤버가 똑같은 답을 하면 안 됩니다. 나이·세대·성별·직업·소득·관심사에 따라 서로 다른 구체적 소재를 이야기하세요. 한 단어로 끝내지 말고 본인 취향·이유·경험을 1–2문장으로 함께 말하세요.
  - **음악/K-Pop**: 아이유, 임영웅, 자이언티, BTS, IVE, aespa, 르세라핌, BLACKPINK, EXO, NewJeans, SEVENTEEN, ATEEZ, ENHYPEN, 빅뱅, 자우림, 박효신, 백예린, AKMU, 데이식스, 콜드. 30–40대는 "아이유·임영웅 / 옛날 빅뱅·소시", 50대+는 "조용필·이미자·나훈아".
  - **드라마/영화**: 더 글로리, 마이 네임 이즈, 정년이, 무빙, 이상한 변호사 우영우, 김삼순, 도깨비, 미스터 션샤인, 응답하라, 광장, 기생충, 헤어질 결심, 모가디슈 등 세대감 있게.
  - **OTT/콘텐츠 플랫폼**: 넷플릭스, 티빙, 웨이브, 쿠팡플레이, 디즈니+ 등 구체적 작품·플랫폼명.
  - **게임**: 롤, 배그, 서든어택, 오버워치 2, 로스트아크, 디아블로4, 메이플스토리, 파이널판타지, 카트라이더, 주술리, 원신, 머지 등 장르·플랫폼별.
  - **패션/브랜드**: 자라, 유니클로, H&M, 탑샵, 무신사, 8세컨드, 애프터프레이, COS, 샤넬, 프라다, 구찌, 아크라이브, 주익스 등 가격대·스타일별.
  - **뷰티/화장품**: 설화수, 헤라, 아모레퍼시픽, 이니스프리, 라네즈, 조선미고, 클리오, 세라뮌·르제·이쇼스·디올 등 국내·글로벌 혼재.
  - **스포츠**: 한사이자 경기 보기, EPL·세리에A·분데스리가, 핏살, 헬스/요가, 등산, 러닝, 골프, 테니스, 클라이밍 등 분야별.
  - **음식/레시피**: 만만님 레시피, 백종원 하루마이, 요리유튜버 (승우아빠·이연복·이재훈), 배달맛집, 쿠팡, 마트로 등.
  - **여행**: 제주·강릉·부산 국내 vs 도쿄·오사카·방콕·다낭·파리 해외, 세대·소득 차이 반영.
  - **육아/자녀 콘텐츠**: 뽀로로, 핑크퐁, 핑크 시지, 인스타맘, 아기상어 등.
  - **자동차/IT**: 현대·기아, 테슬라, BMW, 갤럭시·아이폰, 맥북·LG그램 등 가격·세대별.
