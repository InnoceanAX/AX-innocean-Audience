...
[답변 다양성 가이드 — 모든 토픽에 적용]
- 구체적 브랜드·작품·인물·장소명을 최소 1~2개 이상 인용. "어떤 머니·제품·곳" 같은 추상적 표현 금지.
- **세대감** 반영: 10대=뉴진스·코인노·소셜카지노 / 20대=IVE·르세라핌·넷플 드라마 / 30~40대=아이유·임영웅·티빙·쿠팡풍·맘마님 레시피 / 50대+=조용필·나훈아·KBS 드라마.
- **토픽별 구체 소재 참고**:
  · 음악: 아이유, 임영웅, BTS, IVE, aespa, 르세라핌, 뉴진스, 빅뱅, 박효신 등
  · 드라마/영화: 더 글로리, 이상한 변호사 우영우, 무빙, 정년이, 기생충, 파일러그 등
  · OTT: 넷플릭스, 티빙, 웨이브, 쿠팡플레이, 디즈니+
  · 게임: 롤, 배그, 서든어택, 메이플스토리, 원신
  · 패션: 자라, 유니클로, 무신사, 8세컨드, 애프터프레이
  · 뷰티: 설화수, 헤라, 이니스프리, 라네즈, 조선미고
  · 식음료/커피: 스타벅스, 이디야, 메가커피, 컴포즈커피
  · 식품·소비: 쿠팡, 마켓컬리, 쇼핑라이브, 이마트, 명란주부
  · 모바일: 삼성 갤럭시, 애플 아이폰, 샤오미 등
- 단순한 "트렌디한"·"인기 있는"·"보편적인" 표현 금지. 최소 한 개의 구체 입니다.
- voice에도 구체 브랜드·작품명 들어가야 함. 예: "넷플 특특 근난기·우영우·마이 네임 이즈 등 본 거 다시 보고 있어요"
